...
Nội dung viết sẵn cho mục này đã được tách ra riêng tại [12-dat-van-de-du-an.md](12-dat-van-de-du-an.md).

**2.1.1 Nhu cầu và tầm quan trọng của dự án**

Dự án hiện tại là một **hệ thống quyên góp từ thiện phân tán** cho phép người dùng tạo chiến dịch, tiếp nhận quyên góp, duyệt giao dịch, xem thống kê và kiểm tra trạng thái hệ thống. Đây là một bài toán phù hợp với môn Cơ sở dữ liệu phân tán vì dữ liệu không chỉ cần lưu trữ tập trung mà còn phải phục vụ truy cập từ nhiều máy, nhiều vai trò khác nhau và có yêu cầu sẵn sàng cao.

Hệ thống này giải quyết các vấn đề sau:

- Quản lý nhiều chiến dịch quyên góp cùng lúc, mỗi chiến dịch có thể phát sinh nhiều giao dịch donation.
- Cho phép người dùng truy cập từ nhiều máy khác nhau qua Tailscale mà vẫn đảm bảo dữ liệu nhất quán.
- Hỗ trợ kiểm thử failover và backup/restore để mô phỏng môi trường triển khai thực tế.
- Tách biệt rõ lớp giao diện, lớp xử lý nghiệp vụ và lớp lưu trữ dữ liệu để dễ mở rộng và dễ bảo trì.
...
Nội dung chi tiết cho mục này đã được tách riêng tại [13-phan-tich-va-thiet-ke-2-2-1.md](13-phan-tich-va-thiet-ke-2-2-1.md).
...
Nội dung chi tiết cho mục này đã được tách riêng tại [14-thiet-ke-2-2-2.md](14-thiet-ke-2-2-2.md).
