...
\newcommand{\tocsubsectionitem}[1]{%
  \addcontentsline{toc}{subsubsection}{\protect\numberline{\arabic{subsection}.1}#1}%
}
...
\item Về kiến trúc triển khai, tài liệu mới nhất xác định mô hình gồm \textbf{1 máy phía người dùng cuối kiêm điều phối, kiểm thử tại Hà Nội và 5 shard ngang hàng đặt tại các địa phương khác nhau}:
\begin{itemize}
\item \textbf{Máy 1 tại Hà Nội:} máy phía người dùng cuối, chạy Frontend, Backend, QA và \texttt{mongos}.
\item \textbf{Máy 2 tại Hải Phòng, Máy 3 tại Thanh Hóa, Máy 4 tại Đà Nẵng, Máy 5 tại Hồ Chí Minh, Máy 6 tại Bến Tre:} 5 shard ngang hàng, mỗi máy là một Replica Set shard của hệ thống.
\end{itemize}
\item Máy 1 tại Hà Nội không phải shard dữ liệu nghiệp vụ chính mà là máy phía người dùng cuối, đồng thời làm điểm điều phối ứng dụng, truy vấn và kiểm thử. Backend gửi truy vấn đến \texttt{mongos}; \texttt{mongos} dựa vào metadata sharding để định tuyến truy vấn đến 5 shard đặt tại Hải Phòng, Thanh Hóa, Đà Nẵng, Hồ Chí Minh và Bến Tre. Năm shard này có vai trò như nhau; mỗi shard là một Replica Set gồm 1 Primary và 2 Secondary, vừa phục vụ phân mảnh dữ liệu, vừa phục vụ kiểm thử nhân bản và failover.
...
\tocsubsectionitem{Vị Trí, Nhiệm Vụ và Dữ Liệu Khi Triển Khai Dự Án}
\begin{itemize}
...
\begin{itemize}
\item \textbf{Vị trí 1 - Máy 1 tại Hà Nội:} máy phía người dùng cuối, chạy Frontend, Backend, QA và \texttt{mongos}; là điểm truy cập chính của ứng dụng, điểm điều phối truy vấn MongoDB và nơi thực hiện kiểm thử.
\item \textbf{Vị trí 2 - Máy 2 tại Hải Phòng:} là một shard của hệ thống, lưu dữ liệu đã được phân mảnh, nhận truy vấn do \texttt{mongos} định tuyến và tham gia cơ chế nhân bản, failover.
\item \textbf{Vị trí 3 - Máy 3 tại Thanh Hóa:} là một shard của hệ thống, lưu dữ liệu đã được phân mảnh, nhận truy vấn do \texttt{mongos} định tuyến và tham gia cơ chế nhân bản, failover.
\item \textbf{Vị trí 4 - Máy 4 tại Đà Nẵng:} là một shard của hệ thống, lưu dữ liệu đã được phân mảnh, nhận truy vấn do \texttt{mongos} định tuyến và tham gia cơ chế nhân bản, failover.
\item \textbf{Vị trí 5 - Máy 5 tại Hồ Chí Minh:} là một shard của hệ thống, lưu dữ liệu đã được phân mảnh, nhận truy vấn do \texttt{mongos} định tuyến và tham gia cơ chế nhân bản, failover.
\item \textbf{Vị trí 6 - Máy 6 tại Bến Tre:} là một shard của hệ thống, lưu dữ liệu đã được phân mảnh, nhận truy vấn do \texttt{mongos} định tuyến và tham gia cơ chế nhân bản, failover.
\end{itemize}
\item Cách bố trí này giúp mô hình phân tán thể hiện rõ việc các máy được đặt tại nhiều địa phương khác nhau nhưng vẫn kết nối thành một hệ thống thống nhất qua Tailscale và MongoDB Sharded Cluster.
...
\end{itemize}
\item Nhiệm vụ chung của 5 máy shard đặt tại Hải Phòng, Thanh Hóa, Đà Nẵng, Hồ Chí Minh và Bến Tre:
\begin{itemize}
...
\item \textbf{Vị trí:} chủ yếu thao tác trên Máy 1 tại Hà Nội và kiểm tra các shard đặt tại Hải Phòng, Thanh Hóa, Đà Nẵng, Hồ Chí Minh và Bến Tre.
\item \textbf{Chức năng:}
\begin{itemize}
...
\tocsubsectionitem{Kết Luận Phần Đặt Vấn Đề}
\begin{itemize}
...
\item Với mô hình MongoDB Sharded Cluster gồm 1 máy điều phối tại Hà Nội và 5 shard ngang hàng đặt tại Hải Phòng, Thanh Hóa, Đà Nẵng, Hồ Chí Minh và Bến Tre, dự án có thể mô phỏng đầy đủ các nội dung quan trọng của CSDLPT: phân mảnh dữ liệu, nhân bản trong từng shard, định tuyến truy vấn qua \texttt{mongos}, kiểm thử failover, backup/restore và kiểm soát truy cập theo vai trò. Vì vậy, đây không chỉ là một ứng dụng web quản lý từ thiện mà còn là một mô hình thực hành phù hợp để trình bày trong báo cáo môn Cơ sở dữ liệu phân tán.
\end{itemize}
\clearpage
...
\tocsubsectionitem{Các chức năng chính của hệ thống}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.1}Quản trị viên hệ thống}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.2}Người đóng góp / nhà tài trợ}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.3}Quản lý chi nhánh}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.4}Nhân viên chi nhánh}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.5}Tình nguyện viên}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.6}Người nhận hỗ trợ}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.7}Nhóm vận hành và kiểm thử}
...
\subsection*{I. Thiết kế hệ thống tại các trạm và toàn hệ thống}

\subsubsection*{1.1. Mục tiêu thiết kế}
\addcontentsline{toc}{subsubsection}{\protect\numberline{1.1}Mục tiêu thiết kế}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{1.2}Mô hình triển khai tổng thể}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{1.3}Chức năng của máy 1 -- Controller}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{1.4}Chức năng của các máy shard}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{1.5}Dữ liệu xử lý trong hệ thống}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{1.6}Lược đồ toàn hệ thống}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{1.7}Luồng xử lý truy vấn trong hệ thống}
...
\subsection*{II. Thiết kế cơ sở dữ liệu logic cho toàn hệ thống}

\subsubsection*{2.1. Mục tiêu thiết kế cơ sở dữ liệu}
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.1}Mục tiêu thiết kế cơ sở dữ liệu}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.2}Nguyên tắc thiết kế dữ liệu}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.3}Danh sách collection chính}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.4}Lược đồ collection tổng quát}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.5}Mô tả cấu trúc các collection}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.6}Thiết kế các collection trọng tâm}

\subsubsection*{2.6.1. Collection campaigns}
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.6.1}Collection campaigns}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.6.2}Collection contributions}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.6.3}Collection aid\_distributions}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{2.7}Tổng hợp quan hệ giữa các collection}
...
\subsection*{III. Thiết kế cơ sở dữ liệu phân tán}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{3.1}Lược đồ phục vụ phân mảnh ngang theo \texttt{branchId}}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{3.2}Thiết kế phân mảnh ngang bằng MongoDB Sharding}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{3.3}Thiết kế định vị và sơ đồ định vị dữ liệu}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{3.4}Lược đồ ánh xạ logic -- vật lý}
...
\subsection*{IV. Thiết kế nhân bản và đồng bộ hóa dữ liệu}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{4.1}Sơ đồ nhân bản trong từng shard}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{4.2}Cơ chế đồng bộ dữ liệu bằng oplog}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{4.3}Cơ chế failover khi primary gặp sự cố}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{4.4}Đồng bộ metadata sharding}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{4.5}Phân biệt sharding và replication trong hệ thống}
...
\subsection*{V. Thiết kế vật lý các trạm}

\subsubsection*{5.1. Mục tiêu thiết kế vật lý}
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.1}Mục tiêu thiết kế vật lý}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.2}Phân bổ tổng thể các máy}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.3}Thiết kế vật lý máy 1 -- Controller}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.4}Thiết kế vật lý các máy shard}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.5}Phân bổ dữ liệu vật lý trên các shard}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.6}Sơ đồ thiết kế vật lý các trạm}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.7}Luồng truy cập dữ liệu vật lý}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{5.8}Yêu cầu kết nối giữa các trạm}
